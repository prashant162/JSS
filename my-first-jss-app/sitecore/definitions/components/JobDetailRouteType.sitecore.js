...
export default function(manifest) {
  ...
  manifest.addRouteType({
    ...
    fields: [
      { name: 'Job List Page Title', type: CommonFieldTypes.SingleLineText },
      { name: 'Job List Page Summary', type: CommonFieldTypes.SingleLineText },
      { name: 'Job List Page Desription', type: CommonFieldTypes.RichText },
    ],
  });
}
